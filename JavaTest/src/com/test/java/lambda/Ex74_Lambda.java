...
//		System.out.println(result);
	...
	private static void m6() {
		...
		Function<Integer, Integer> f9 = f7.compose(f6);
...
@FunctionalInterface //1. 남에게 역할 알리기 위해서 2. 문법 체크(추상 메소드 1개인지 검사)
...
interface Test {
	...
	public static void bbb() { //개인 행동 > 모드의 행동
